...
func newKeyMap() keyMap {
	return keyMap{
		...
		HubConnect:  key.NewBinding(key.WithKeys("ctrl+r"), key.WithHelp("ctrl+r", "refresh Buzz")),
		HubDeploy:   key.NewBinding(key.WithKeys("ctrl+d"), key.WithHelp("ctrl+d", "deploy Buzz")),
